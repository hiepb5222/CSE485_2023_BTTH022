...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active"
                                href="/index.php?controller=home&action=login">Đăng
                                nhập</a>
                        </li>
                    </ul>
    ...
    <main class="container-fluid mt-5 mb-5">
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="./index.php?controller=member&action=resigter" method="POST">
                        ...
                        <div class="input-group mb-3 ">
                            <span class="text" style="color:red ;margin-left:140px;font-weight:12px;" id="errorName"></span>
                        </div>
                        ...
                        <div class="form-group  float-end ">
                            <input type="submit" id="signbtn" name="signbtn" value="Đăng ký" class="btn btn-success">
    ...
    <footer class="bg-white d-flex justify-content-center align-items-center border-top border-secondary  border-2"
        style="height:80px;position:absolute;width:100%;bottom:0;">
